        ...
        <div class="grid container-fluid" style="width:80%">
            ...
            <div class="row row-xs-middle">
                ...
                <div class="row justify-content-center ">
                    ...
                    <?php echo do_shortcode('[ajax_load_more search="' .  get_search_query() . '" no_results_text="با متن جستجو ، عنوان یا موضوع انتخاب شده مقاله ای یافت نشد" transition_container_classes="row" scroll="false" post_type="post, portfolio" posts_per_page="6" button_label="مشاهده بیشتر"]') ?>
                ...
                <div class="row justify-content-center">
                    ...
                    */ ?>
                    ...
                    <br/>
                    <div class="grid container-fluid  mt-4" style="width:80%">
                        <div class="row row-xs-middle">
