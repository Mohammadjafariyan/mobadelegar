 ...
 */
$height = $el_class = $el_id = $css = $cryptoland_vc_space = '';
...
?>
<div class="<?php echo esc_attr( trim( $css_class ) ); ?> <?php echo esc_attr( trim( $cryptoland_vc_space ) ); ?>" <?php echo implode( ' ', $wrapper_attributes ); ?> <?php echo esc_attr( $inline_css ); ?> ><span class="vc_empty_space_inner"></span></div>
