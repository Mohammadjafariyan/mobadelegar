 ...
 */
$el_class = $width = $css = $offset = $cryptoland_lgbg_pos = $cryptoland_mdbg_pos = $cryptoland_smbg_pos = $cryptoland_xsbg_pos =  $cryptoland_hidebg_992 = $cryptoland_hidebg_768 = $cryptoland_hidebg_576 = $cryptoland_vc_css_992 = $cryptoland_vc_css_768 = $cryptoland_vc_css_576 = '';
$output = '';
...
$css_classes[] = $cryptoland_xsbg_pos != '' ? 'xs-bg-'.$cryptoland_xsbg_pos : '';
	...
	$cryptoland_delay = $cryptoland_delay != '' ? ' data-aos-delay="'.$cryptoland_delay .'"': '';
	$cryptoland_anim = $cryptoland_addanim == true && $cryptoland_anim != '' ? ' data-aos="'.esc_attr($cryptoland_anim).'"'.$cryptoland_delay : '';
...
$output .= '<div ' . implode( ' ', $wrapper_attributes ) .$respon.$cryptoland_anim. '>';
