...
if ( 'nivo' === $type ) {
 ...
 elseif ( 'owl_slider' === $type ) {
	$el_start = '<div class="project-image carousel-image popup-gallery"><div class="hover-overlay">';
	$el_overlay = '<div class="item-overlay"></div>';
	$el_end = '</div></div>';
	$slides_wrap_start = '<div class="carousel-slider"><div class="owl-carousel owl-theme images-carousel">';
...
foreach ( $images as $i => $image ) {
	...
	switch ( $onclick ) {
		...
		case 'mfp':
				$link_start = '<div class="image-zoom"><a href="' . $large_img_src . '">';
				$link_end = '<i class="fa fa-search-plus"></i></a></div> ';
				
			break;
	}
	if ( 'owl_slider' === $type AND 'mfp' === $onclick ) {
		$gal_images .= $el_start . $thumbnail . $el_overlay . $link_start  . $link_end . $el_end;
	} else{
